...
export default function CreateJob() {
  ...
  // Changed from 6 to match the number of steps in renderCurrentStep
  const totalSteps = 6
  ...
  const handleNext = async () => {
    ...
    // Skip validation for steps 5, 6, and 7
  ...
  const onSubmit = async (data: JobFormSchema) => {
    ...
    // Remove the step condition to test if onSubmit works at all
    // if (currentStep !== totalSteps) {
    //   console.log('Submission blocked because currentStep !== totalSteps', { currentStep, totalSteps })
    //   return
    // }
