...
export function CustomQuestionsBuilder({
  ...
  const [globalScoringMode, setGlobalScoringMode] = useState<
    "simple" | "advanced"
  >("simple");
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Create custom questions to gather specific information from
              applicants.
              {hasAIFeatures &&
                globalScoringMode === "advanced" &&
                " Configure AI scoring to automatically evaluate responses."}
              {hasAIFeatures &&
                globalScoringMode === "simple" &&
                " AI will automatically score responses."}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                {questionForm.scoringType === "greater_than" && (
                  <div className="text-xs text-blue-600 bg-blue-50 p-2 rounded">
                    <strong>Greater Than Mode:</strong> Options with higher
                    values will score better than lower values
                  </div>
                )}
                <div className="space-y-2">
                ...
                <div className="space-y-3">
                  ...
                  {questionForm.type === "text" && (
                    <Input
                      disabled
                      placeholder={
                        questionForm.placeholder || "Enter your answer here..."
                      }
                      className="bg-white"
                    />
                  )}
                  ...
                  {questionForm.type === "number" && (
                    <Input
                      ...
                      disabled
                      placeholder={
                        questionForm.placeholder || "Enter a number..."
                      }
                      className="bg-white"
                    />
                  )}
                  {questionForm.type === "email" && (
                    <Input
                      ...
                      disabled
                      placeholder={
                        questionForm.placeholder || "Enter email address..."
                      }
                      className="bg-white"
                    />
                  )}
                  {questionForm.type === "phone" && (
                    <Input
                      ...
                      disabled
                      placeholder={
                        questionForm.placeholder || "Enter phone number..."
                      }
                      className="bg-white"
                    />
                  )}
            ...
            {hasAIFeatures && globalScoringMode === "simple" && (
              <div className="text-xs text-blue-600 bg-blue-50 p-3 rounded border border-blue-200">
                <strong>Simple Mode:</strong> AI will automatically determine
                the best answers and weight all questions equally.
              </div>
            )}
          </div>
                      ...
                      <div className="ml-4">
                        ...
                        {question.type === "email" && (
                          <Input
                            ...
                            disabled
                            placeholder={
                              question.placeholder || "Enter email address..."
                            }
                            className="bg-white"
                          />
                        )}
                        ...
                        {(question.type as string) === "time" && (
                          <Input type="time" disabled className="bg-white" />
                        )}
                        {(question.type as string) === "file" && (
                          <Input type="file" disabled className="bg-white" />
                        )}
                        {question.type === "select" && (
                          <Select disabled>
        ...
        <Card className="border-dashed border-2 border-gray-200">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-sm text-gray-500 mb-4 max-w-md mx-auto">
              Add custom screening questions to gather specific information from
              applicants. Use templates to get started quickly.
            </p>
            <Button
              type="button"
