        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Connect your calendars to check for busy times and prevent double bookings
              </CardDescription>
            </div>
            <Button
        ...
        <CardContent className="space-y-4">
              ...
              <div className="flex-1">
                ...
                {isConnected && platformSettings && (
                  <div className="mt-2 space-y-1">
                    ...
                    <p className="text-xs text-gray-500 ml-4">{platformSettings.email}</p>
                  </div>
                )}
                {!isConnected && (
          ...
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium text-blue-900 mb-1">How Calendar Integration Works</h4>
                <ul className="text-sm text-blue-700 space-y-1">
                  <li>• Connected calendars are checked for existing meetings</li>
                  <li>• Time slots with conflicts are automatically hidden from candidates</li>
                  <li>• Interview slots are created in your connected calendar</li>
                  <li>• Meeting links are automatically generated and shared</li>
                </ul>
              </div>
            </div>
          </div>
