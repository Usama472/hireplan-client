...
export default function JobExpiredTrigger() {
  ...
  const jobConditionFields = [
    ...
    { value: "application_count", label: "Application Count" },
  ];

  const getOperators = (field: string) => {
    if (field === "days_active" || field === "application_count") {
      return [
  ...
  // Available action types for job expired
  const actionTypes = [
    {
  ...
  const isNumericField = (fieldId: string) => {
    return fieldId === "days_active" || fieldId === "application_count";
  };

  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      <div className="bg-gradient-to-r from-red-50 to-transparent rounded-lg p-6 border-l-4 border-red-500">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600">
              This automation runs when a job posting reaches its expiration
              date
            </p>
          </div>
        </div>
      ...
      {/* Conditions Section */}
      <div className="rounded-lg overflow-hidden bg-white border border-gray-100">
        <div className="bg-gradient-to-r from-red-50 to-white p-4 flex justify-between items-center border-b border-gray-100">
          <h2 className="text-lg font-medium text-gray-800 flex items-center">
          ...
          {useConditions ? (
            <div className="space-y-4">
              ...
              {conditions.map((condition) => (
                <div
                  key={condition.id}
                  className="flex items-start gap-3 bg-red-50/50 p-4 rounded-lg"
                >
                  <div className="flex-1 grid grid-cols-3 gap-3">
                    ...
                    <Input
                      placeholder={
                        condition.field === "days_active"
                          ? "Enter days"
                          : condition.field === "application_count"
                          ? "Enter count"
                          : "Enter value"
                      }
            ...
            <div className="flex items-center justify-center p-8 bg-red-50/30 rounded-lg">
              <div className="text-center">
                <p className="text-gray-500 mb-2">No conditions specified</p>
                <p className="text-sm text-gray-400">
                  This automation will run for every expired job
                </p>
                <Button
                  variant="outline"
                  size="sm"
      ...
      <div className="flex justify-end mt-8 pt-4 border-t">
        <div className="flex gap-3">
          ...
          <Button
            onClick={handleSave}
            className="bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white px-8 py-2"
          >
            Save Automation
          </Button>
        </div>
