...
export default function JobCreatedTrigger() {
  ...
  // Available action types for job created
  const actionTypes = [
    {
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      <div className="bg-gradient-to-r from-amber-50 to-transparent rounded-lg p-6 border-l-4 border-amber-500">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600">
              This automation runs when a new job is created in the system
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Conditions Section */}
      <div className="rounded-lg overflow-hidden bg-white border border-gray-100">
        <div className="bg-gradient-to-r from-amber-50 to-white p-4 flex justify-between items-center border-b border-gray-100">
          <h2 className="text-lg font-medium text-gray-800 flex items-center">
          ...
          {useConditions ? (
            <div className="space-y-4">
              ...
              {conditions.map((condition) => (
                <div
                  key={condition.id}
                  className="flex items-start gap-3 bg-amber-50/50 p-4 rounded-lg"
                >
              ...
              <div className="mt-4">
                <Button
                  ...
                  className="flex items-center gap-1 border-amber-200 text-amber-600 hover:bg-amber-50"
                >
            ...
            <div className="flex items-center justify-center p-8 bg-amber-50/30 rounded-lg">
              <div className="text-center">
                <p className="text-gray-500 mb-2">No conditions specified</p>
                <p className="text-sm text-gray-400">
                  This automation will run for every new job
                </p>
                <Button
                  variant="outline"
                  size="sm"
                  className="mt-3 border-amber-200 text-amber-600 hover:bg-amber-50"
                              ...
                              .filter(
                                (template) =>
                                  template.name
                                    ?.toLowerCase()
                                    .includes("team") ||
                                  template.name?.toLowerCase().includes("job")
                              )
                              .map((template) => (
                                <SelectItem
                                  key={template.id}
