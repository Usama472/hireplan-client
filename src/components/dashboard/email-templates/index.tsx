          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-600 flex items-center gap-2">
                    Create and manage your recruitment email templates
                    <Badge
                      variant="secondary"
              ...
              <div className="flex items-center gap-3">
                <Button
                  onClick={() =>
                    navigate(ROUTES.DASHBOARD.CREATE_EMAIL_TEMPLATE)
                  }
                  className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 hover:from-blue-600 hover:via-purple-600 hover:to-pink-600 text-white border-0 transition-all duration-200 gap-2"
                >
      ...
      <div className="px-6 max-w-7xl mx-auto">
        <div className="relative max-w-md mt-10">
          ...
          <Input
            ...
            className="pl-11 border-border/50 focus:border-primary focus:ring-2 focus:ring-primary/20 h-11 rounded-md text-sm bg-white transition-all duration-200"
          />
          {searchQuery && (
            <button
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
            {[...Array(6)].map((_, i) => (
              <div
                key={i}
                className="bg-white border border-gray-200 rounded-lg p-5 flex flex-col h-full"
              >
                {/* Header */}
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-12 text-center mt-10">
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredTemplates.map((template) => (
                <div
                  key={template.id}
                  className="group bg-white border border-gray-200 rounded-lg p-5 transition-all duration-300 hover:border-gray-300 flex flex-col h-full"
                >
                  {/* Header with Status */}
                  <div className="flex justify-between items-start mb-3">
                    <div className="flex items-center gap-2">
                  ...
                  <div className="mt-auto">
                    <Button
                      variant="outline"
                      className="w-full text-gray-500 border-gray-200 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 h-11 rounded-lg transition-all duration-200"
                      onClick={() =>
                        navigate(
            ...
            <div className="mt-10 text-center">
              <div className="inline-flex items-center gap-2 bg-white border border-gray-200 rounded-lg px-6 py-3">
