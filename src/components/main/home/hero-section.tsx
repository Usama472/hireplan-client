...
export function HeroSection() {
  ...
  return (
    <section className="relative pt-16 pb-8 overflow-hidden bg-primary">
      ...
      <div className="absolute top-20 right-10 w-64 h-64 bg-gradient-to-r from-blue-400/20 to-purple-400/20 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          >
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-4 text-center">
              ...
              <h3 className="text-white font-semibold text-sm mb-2">Job Management</h3>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-4 text-center">
              ...
              <h3 className="text-white font-semibold text-sm mb-2">AI Screening</h3>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-4 text-center">
              ...
              <h3 className="text-white font-semibold text-sm mb-2">Auto Communication</h3>
          ...
          <motion.div variants={itemVariants} className="mb-8">
            <Button
              size="lg"
              className="h-12 px-8 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-md shadow-lg hover:shadow-xl transition-all duration-300"
            >
